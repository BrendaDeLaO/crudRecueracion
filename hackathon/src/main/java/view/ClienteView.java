...
public class ClienteView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnRegistrar.setIcon(new javax.swing.ImageIcon("C:\\Users\\Santa Ana\\Downloads\\hackathon-TARDE\\hackathon\\src\\main\\java\\images\\registrar.png")); // NOI18N
        ...
        btnEditar.setIcon(new javax.swing.ImageIcon("C:\\Users\\Santa Ana\\Downloads\\hackathon-TARDE\\hackathon\\src\\main\\java\\images\\editar.png")); // NOI18N
        ...
        btnEliminar.setIcon(new javax.swing.ImageIcon("C:\\Users\\Santa Ana\\Downloads\\hackathon-TARDE\\hackathon\\src\\main\\java\\images\\eliminar.png")); // NOI18N
        ...
        btnLimpiar.setIcon(new javax.swing.ImageIcon("C:\\Users\\Santa Ana\\Downloads\\hackathon-TARDE\\hackathon\\src\\main\\java\\images\\limpiar.png")); // NOI18N
    ...
    void registrar() {
        ...
        try {
            String sql = "INSERT INTO CLIENTE(DNICLI, NOMBRES, APELLIDOS, DIRECCION, CELULAR, SEXO) values('" + dni + "','" + nombres + "','" + apellidos + "','" + direccion + "','" + celular + "','" + sexo + "')";
            con = conexion.Conexion();
            st = con.createStatement();
    ...
    void editar() {
        ...
        try {
            String sql = "UPDATE CLIENTE SET DNICLI='" + dni + "', NOMBRES='" + nombres + "', APELLIDOS='" + apellidos + "', DIRECCION='" + direccion + "', CELULAR='" + celular + "', SEXO='" + sexo + "' WHERE IDCLI=" + id;
            con = conexion.Conexion();
            st = con.createStatement();
            st.executeUpdate(sql);
